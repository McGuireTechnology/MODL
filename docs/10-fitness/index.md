...
<figure>
    <img src="../../assets/images/impairment-factors.svg" alt="Impairment factors: Alcohol/Drugs, Fatigue, Medications." style="max-width:640px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Stacked factors compound risk—plan rest and review meds.</figcaption>
</figure>
