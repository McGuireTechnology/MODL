...
<figure>
    <img src="../../assets/images/lane-change-sequence.svg" alt="Six-step lane change sequence diagram: mirror, signal, shoulder check, adjust, move, cancel." style="max-width:660px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Lane change steps reinforce deliberate, predictable movement.</figcaption>
</figure>
