---
title: License Basics (Chapter 1)
---
# License Basics (Chapter 1)
...
!!! note "Verify official specifics"
...
<figure>
   <img src="../../assets/images/testing-sequence.svg" alt="Testing sequence diagram: Vision screening then Knowledge exam then Road test." style="max-width:680px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
   <figcaption style="text-align:center;font-size:0.85rem;">The typical order is Vision → Knowledge → Road test.</figcaption>
</figure>
...
<figure>
   <img src="../../assets/images/documents-proof.svg" alt="Three proof categories: Identity and lawful presence, Social Security number, and Missouri residency." style="max-width:680px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
   <figcaption style="text-align:center;font-size:0.85rem;">Bring originals or certified documents; names should match across proofs.</figcaption>
</figure>
