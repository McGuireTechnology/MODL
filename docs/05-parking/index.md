...
<figure>
    <img src="../../assets/images/hill-parking.svg" alt="Diagram showing uphill with curb wheels turned away, downhill with curb wheels turned toward, and no curb wheels turned toward road edge." style="max-width:640px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Wheel direction changes prevent roll into traffic.</figcaption>
</figure>
...
1. Signal + position beside forward vehicle (~parallel, short gap).
2. Reverse turning toward curb, clearing rear bumper.
3. Straighten wheels, continue backing.
4. Turn opposite direction to center in space.
5. Final adjustments leaving safe distance from vehicles ahead/behind.
