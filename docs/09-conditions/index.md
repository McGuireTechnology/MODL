...
<figure>
    <img src="../../assets/images/hydroplaning.svg" alt="Hydroplaning diagram: tires lifted by water layer, showing reduced traction area beneath tires." style="max-width:600px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Reduce speed before standing water; loss of grip demands smooth corrections.</figcaption>
</figure>
