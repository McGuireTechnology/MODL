...
<figure>
    <img src="../../assets/images/right-of-way-4way.svg" alt="At a 4‑way stop with simultaneous arrival, yield to the vehicle on your right." style="max-width:640px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Yielding to the right avoids deadlocks at simultaneous arrival.</figcaption>
</figure>
