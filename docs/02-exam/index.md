...
<figure>
    <img src="../../assets/images/testing-sequence.svg" alt="Testing sequence: Vision screening → Knowledge exam → Road test." style="max-width:680px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Plan prep for each phase in the sequence.</figcaption>
</figure>
