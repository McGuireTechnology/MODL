...
<figure>
    <img src="../../assets/images/distraction-types.svg" alt="Three distraction types: Visual (eyes off road), Manual (hands off wheel), Cognitive (mind off driving)." style="max-width:640px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Recognize and minimize each category to cut risk.</figcaption>
</figure>
