# Everyday Driving Tips (Chapter 8)
...
<figure>
    <img src="../../assets/images/scan-cycle.svg" alt="Scan cycle: Front → Mirrors → Gauges → Blind spots, then repeat." style="max-width:620px;width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.85rem;">Use a repeatable scan cycle to reduce surprises.</figcaption>
</figure>
