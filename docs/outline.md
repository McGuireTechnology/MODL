...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;align-items:center;">
  <figure style="margin:0;">
    <img src="assets/images/sign-shapes.svg" alt="Sign shapes and meanings" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">Signs</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/testing-sequence.svg" alt="Testing sequence" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">Exam flow</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/right-of-way-4way.svg" alt="4-way stop right-of-way" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">Right-of-way</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/no-zones.svg" alt="Truck no-zones" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">No‑zones</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/scan-cycle.svg" alt="Scan cycle for everyday driving" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">Scan cycle</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/lane-change-sequence.svg" alt="Lane change sequence" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">Lane change</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/impairment-factors.svg" alt="Impairment risk factors" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
    <figcaption style="text-align:center;font-size:0.75rem;">Fitness</figcaption>
  </figure>
  <figure style="margin:0;">
    <img src="assets/images/points-gauge.svg" alt="Point system gauge" style="width:100%;border:1px solid #e0e0e0;border-radius:8px;" />
